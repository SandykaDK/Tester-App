        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <form method="POST" action="{{ route('menus.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="menu_name" id="menu_name" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    @error('menu_name')
                ...
                <div class="mb-4">
                    ...
                    <textarea name="menu_description" id="menu_description" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></textarea>
                </div>
                <div class="mb-4">
