@if (session('failure'))
    <div id="alert-failure-testcase" class="fixed top-0 left-0 right-0 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded shadow-md mx-auto mt-4 max-w-lg z-50 transition-opacity duration-500 ease-in-out opacity-0" role="alert">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const alert = document.getElementById('alert-failure-testcase');
